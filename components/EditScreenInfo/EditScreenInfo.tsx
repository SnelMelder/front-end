  ...
  <ScrollView>
    <View style={styles.getStartedContainer}>
      ...
      <Text style={styles.getStartedText} lightColor="rgba(0,0,0,0.8)" darkColor="rgba(255,255,255,0.8)">
        Een incident meld je altijd intern. Wanneer je kunt leren van een incident, omdat in de zorgverlening iets niet
        goed is gegaan, meld je het incident in het Veilig Incidenten Melden (VIM) of het Melding Incidenten Cliënten
        (MIC)-systeem.
      </Text>
      <Text />
      <Text />
